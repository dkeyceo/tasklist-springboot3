...
import com.dkey.tasklist.repository.DataSourceConfig;
import com.dkey.tasklist.repository.UserRepository;
import com.dkey.tasklist.repository.mappers.TaskRowMapper;
import com.dkey.tasklist.repository.mappers.UserRowMapper;
...
public class UserRepositoryImpl implements UserRepository{
	...
	public boolean isTaskOwner(Long userId, Long taskId) {
		try {
			...
			throw new ResourceMappingException("Error while checking if user is owner of task");
		}
	}
